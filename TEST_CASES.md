...
|---|---|---|
| AUTH-001 | Register a unique user with `authority=user` | `200 OK`, success message |
...
| ID | Scenario | Expected Result |
|---|---|---|
| BOOK-001 | Add a book as an authenticated user | `200 OK`, response contains author, title, and user |
...
| BOOK-004 | Read owned books after adding a book | `200 OK`, list contains created title |
| BOOK-005 | Read held books after adding a book | `200 OK`, list contains created title |
| BOOK-006 | Read held books without authentication | `401 Unauthorized` |
